...
<div class="page-wrap">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-xs-8">
						<?php echo ((trim($arrPosting["salary"])!=""&&$arrPosting["salary"]!="0" )?$arrPosting["salary"]:" A discuter");?>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-xs-8">
						<?php echo $website->job_type($arrPosting["job_type"]);?>
					</div>
					<div class="clearfix"></div>
					<?php
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<a href="<?php echo $website->company_jobs_link($arrEmployer["id"],$arrEmployer["company"]);?>" class="underline-link"><?php echo "Autres offres du recruteur";?></a>
			<br/>
