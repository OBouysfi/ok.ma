...
$file = file_get_contents2("https://www.marocannonces.com/flux/xml/okjoball.xml");
...
class insertAds {
	...
	public function delete_employers()
	{
		...
		$this->db->query("TRUNCATE TABLE `jobsportal_employers`;"); //
		return true;
	}
	...
	public function delete_jobs()
	{
		...
		$this->db->query("TRUNCATE TABLE `jobsportal_jobs`;"); //
		return true;
	}	
