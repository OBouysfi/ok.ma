...
function show_job($job)
{
	...
	echo '<li>Offre N°: '.stripslashes($job["ref"]).'</li>';
	echo '</ul>';
	...
	echo '<div class="row"><div class="col-xs-6"><a href="'.$strLink.'" class="job-details-link underline-link" style="float:none">'.$M_JOB_DETAILS.'</a></div>';
